...
\fancypagestyle{plain}{\fancyhf{}\cfoot{\thepage\ / \pageref{LastPage}}} % Define a custom page style
...
\begin{tabular}[t]{@{}l@{}}
\parbox[t]{0.8\linewidth}{\raggedright \textbf{#3}, \textit{#4}}\\
\parbox[t]{0.8\linewidth}{\raggedright #5}
