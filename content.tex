...
Elite Graduate Program for a small group of students with a focus on the areas Formal Methods, Project Management, Distributed Systems, Databases, Human Computer Interaction and soft-skills. Additional courses in Machine Learning.
\\
...
We are also investigating the robustness of deep convolutional neural networks and the role of context for object detection
}{% 6: Technologies
Matlab, Python, keras, Theano, Linux, ECoG, LSF
}
